...
function Personaldetail() {
  ...
  useEffect(() => {
    const getprofileDetail = async () => {
      try {
        const result = await fetchDetail(''); // Use the function 
        console.log(result);
        setDetail((prev)=>{
          return {
            ...prev,
  ...
  return (
    <Fragment>
      <div className="h-full overflow-y-auto bg-white w-full px-3" style={{
...
<div className="p-5">
  ...
  <p className="text-[gray]">
    I am [Entrepreneur's Name], a passionate innovator dedicated to reshaping
    industries. With creativity and resilience, I thrive in the entrepreneurial
    realm, turning challenges into opportunities. Join me as I make my mark on
    the world.{" "}
  ...
  <div className="p-5">
      ...
      <div className="flex flex-wrap gap-4 mt-5">
        ...
        <div className="w-full sm:w-[48%] md:w-[31%] lg:w-[45%]">
          ...
          {openDropdown === 'work' && (
            <div className="border p-2 rounded-md">
              <span>{detail.work_experience}</span>
            </div>
          )}
        </div>
